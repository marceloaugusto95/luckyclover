-- Migration: Remove automatic contest creation from process_draw
-- After processing bets, the system will NO LONGER auto-create the next contest.
-- Admins must manually create new contests via the UI.
...
BEGIN
    ...
    -- NOTE: Automatic next contest creation has been REMOVED.
    -- Admins must manually create new contests via the UI.
