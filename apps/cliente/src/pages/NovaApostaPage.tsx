...
export default function NovaApostaPage() {
    ...
    const [nextConcurso, setNextConcurso] = useState<number | null>(null);
    ...
    useEffect(() => {
        getMegaSenaResult().then(res => {
            setNextConcurso(res.proximoConcurso);
        });
    ...
    const handleAddToCart = () => {
        ...
        if (!nextConcurso) {
            alert('Erro ao carregar concurso. Tente recarregar a página.');
            return;
        }
        ...
        return (
            <div style={{ padding: '2rem', textAlign: 'center' }}>
                <div className="card" style={{
                    ...
                    <h2 style={{ color: '#c62828', marginBottom: '1rem' }}>Apostas Suspensas</h2>
                    <p style={{ color: '#b71c1c', marginBottom: '2rem' }}>
                        {lockInfo.message || 'Novas apostas estão bloqueadas temporariamente.'}
                    </p>
    ...
    return (
        <div style={{ paddingBottom: '10rem' }}> {/* Extra padding for bottom sheet */}
            {/* Header */}
            ...
            <div className="card" style={{ marginBottom: '1rem' }}>
                <h2 style={{ fontSize: '1rem', marginBottom: '1rem', display: 'flex', justifyContent: 'space-between' }}>
